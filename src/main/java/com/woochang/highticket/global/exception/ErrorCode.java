...
public enum ErrorCode {
    ...
    PERFORMANCE_UPDATE_REQUEST_INVALID(HttpStatus.BAD_REQUEST, "PERFORMANCE_UPDATE_REQUEST_INVALID", "요청한 공연 정보 업데이트 필드가 없습니다."),
    ...
    PERFORMANCE_SCHEDULE_UPDATE_REQUEST_INVALID(HttpStatus.BAD_REQUEST, "PERFORMANCE_SCHEDULE_UPDATE_REQUEST_INVALID", "요청한 업데이트 필드가 없습니다."),

    // PERFORMANCE SCHEDULE SEAT 관련
    PERFORMANCE_SCHEDULE_SEAT_NOT_FOUND(HttpStatus.NOT_FOUND, "PERFORMANCE_SCHEDULE_SEAT_NOT_FOUND", "해당 공연 일정에 대한 좌석 정보가 존재하지 않습니다."),
    PERFORMANCE_SCHEDULE_SEAT_UPDATE_REQUEST_INVALID(HttpStatus.BAD_REQUEST, "PERFORMANCE_SCHEDULE_SEAT_UPDATE_REQUEST_INVALID", "요청한 좌석 정보 업데이트 필드가 없습니다."),
    PERFORMANCE_SCHEDULE_SEAT_CODE_BLANK(HttpStatus.BAD_REQUEST, "PERFORMANCE_SCHEDULE_SEAT_CODE_BLANK", "좌석 코드는 공백일 수 없습니다."),

    // JSON 관련
    INVALID_JSON_REQUEST(HttpStatus.BAD_REQUEST, "INVALID_JSON_REQUEST", "잘못된 요청입니다."),

    // ENUM 관련
    INVALID_ENUM_VALUE(HttpStatus.BAD_REQUEST, "INVALID_ENUM_VALUE", "잘못된 ENUM 값입니다."),
